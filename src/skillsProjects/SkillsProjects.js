...
import Announcement from '../Resources/Images/Announcement.png';
...
class SkillsProjects extends React.Component {
  ...
  render() {
    return (
      <div id="grid" className="container-fluid">
        <div className="row">
          <div className={`col-4 ${classes.cell1}`}>
          ...
          <div className={`col-4 ${classes.cell2}`} onClick={() => {
          ...
          <div className={`col-4 ${classes.cell3}`} onClick={() => {
        ...
        <div className="row">
          <div className={`col-4 ${classes.cell4}`} onClick={() => {
                        const body = "I participated in the SHAD program which is a summer camp centered around STEM and entrepreneurship. As our final project, we designed a product called BeamChase, which was an external add-on to your phone or iPod which allowed you to play laser tag outdoors. \nI led the tech team into designing a prototype made using an Arduino, IR sensor and emitter, and a bluetooth module which communicated with an Android app. \nOur team won 2nd place for the Best Business Plan and 3rd for the Best Marketing. I guess you can say that we were all BEAMING with joy that day!";
          ...
          <div className={`col-4 ${classes.cell5}`} onClick={() => {
          ...
          <div className={`col-4 ${classes.cell6}`} onClick={() => {
        ...
        <div className="row">
          <div className={`col-4 ${classes.cell7}`} onClick={() => {
          ...
          <div className={`col-4 ${classes.cell8}`}>
            <p className={classes.text}> Check out my Github account below! </p>
              <div className={classes.button}>  
                <a target="_blank" href='https://github.com/emily827'>git checkout myProfile</a>
              </div>
          </div>
          <div className={`col-4 ${classes.cell9}`}  onClick={() => {
